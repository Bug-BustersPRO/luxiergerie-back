...
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('1', '1', 'Coca', 'coca.jpg', 'Coca cola', '2.5', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('2', '1', 'Fanta', 'fanta.jpg', 'Fanta orange', '2.5',  0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('3', '1', 'Sprite', 'sprite.jpg', 'Sprite', '2.5', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('4', '2', 'Salade verte', 'salade.jpg', 'La salade verte et sa sauce au basilique sauvage (capturé par un dresseur renommé).', '7.90', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('5', '2', 'Salade César', 'salade.jpg', 'Salade préparée par Jules César lui-même!! (voyage dans le temps inclus)', '150350', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('6', '3', 'Steak frites', 'steak.jpg', 'Steak de boeuf accompagné de frites maison', '15.90', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('7', '3', 'Poulet rôti', 'poulet.jpg', 'Poulet rôti accompagné de pommes de terre', '12.90', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('8', '4', 'Tarte aux pommes', 'tarte.jpg', 'Tarte aux pommes et sa boule de glace vanille', '7.90', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('9', '4', 'Mousse au chocolat', 'mousse.jpg', 'Mousse au chocolat et sa crème chantilly', '7.90', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('10', '5', 'Chemise', 'chemise.jpg', 'Nettoyage de chemise', '5.4', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('11', '5', 'Pantalon', 'pantalon.jpg', 'Nettoyage de pantalon', '7.2', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('12', '6', 'Chambre simple', 'chambre.jpg', 'Nettoyage de chambre simple (si vous avez fait la fête un peu mais pas trop)', '20', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('13', '6', 'Chambre double', 'chambre.jpg', 'Nettoyage de chambre double (si vous avez fait la "fête" un peu mais pas trop)', '30', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('14', '7', 'Vidange', 'reparation.jpg', 'Vidange de votre véhicule, huile premium de qualité, pressée depuis l"olivier du jardin', '150', 0);
INSERT INTO accommodation (id, category_id, name, image, description, price, is_reservable) VALUES ('15', '7', 'Pneus', 'reparation.jpg', 'Une sélection de pneus de qualité, à partir de 200€ le pneu', '200', 0);
