...
INSERT INTO sojourn (id, client_id, room_id, entry_date, exit_date, status, pin, sojourn_identifier) VALUES (UUID_TO_BIN('e4f522cc-d0bd-419f-9034-faf1f19bbd75'), UUID_TO_BIN('a0618bf9-75b5-49d2-9e93-fca420910755'), UUID_TO_BIN('e4f522cc-d0bd-419f-9034-faf1f19bbd72'), '2024-07-24', '2024-07-30', 'IN_PROGRESS', 1234, 'SOJ12346');
INSERT INTO sojourn (id, client_id, room_id, entry_date, exit_date, status, pin, sojourn_identifier) VALUES (UUID_TO_BIN('e4f522cc-d0bd-419f-9034-faf1f19bbd76'), UUID_TO_BIN('a0618bf9-75b5-49d2-9e93-fca420910756'), UUID_TO_BIN('e4f522cc-d0bd-419f-9034-faf1f19bbd73'), '2024-07-25', '2024-10-05', 'IN_PROGRESS', 1234, 'SOJ12347');
INSERT INTO sojourn (id, client_id, room_id, entry_date, exit_date, status, pin, sojourn_identifier) VALUES (UUID_TO_BIN('e4f522cc-d0bd-419f-9034-faf1f19bbd77'), UUID_TO_BIN('a0618bf9-75b5-49d2-9e93-fca420910757'), UUID_TO_BIN('e4f522cc-d0bd-419f-9034-faf1f19bbd74'), '2024-07-26', '2024-09-28', 'IN_PROGRESS', 1234, 'SOJ12348');